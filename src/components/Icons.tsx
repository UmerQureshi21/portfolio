...
export function GitHubButton({ url }: GitHubButtonProps) {
  return (
    <a
      ...
      className="flex items-center justify-center w-9 h-9 accent-bg accent-bg-hover transition-colors rounded-[10px]"
    >
...
export function EmailButton({ email }: EmailButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex items-center justify-center w-9 h-9 accent-bg accent-bg-hover transition-colors rounded-[10px] cursor-pointer"
    >
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
//                 <button
//                   onClick={handleSend}
//                   className="px-4 py-2 accent-bg accent-bg-hover text-white rounded-md transition-colors font-medium"
//                 >
//                   Send
//                 </button>
//               </div>
