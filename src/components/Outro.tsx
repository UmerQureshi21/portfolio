        ...
        <div className="flex max-[1000px]:flex-col max-[1000px]:items-center gap-10 max-[1000px]:gap-6">
          {links.map((link) => (
            <a
              ...
              className="flex items-center gap-2 text-[var(--fg)] no-underline text-[1.1rem] font-normal opacity-70 tracking-widest uppercase transition-opacity duration-300 hover:opacity-100"
            >
              {icons[link.label]}
              {link.label}
            </a>
