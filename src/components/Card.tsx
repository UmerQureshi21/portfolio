  ...
  return (
    ...
    >
      ...
      >
        ...
        <div data-lenis-prevent className="front-detail absolute inset-0 z-10 pt-6 px-8 pb-8 opacity-0 pointer-events-none overflow-y-auto text-left flex flex-col gap-3">
