          ...
          <div className="flex items-center gap-4">
              ...
              (entry.logoLink ? (
                ...
                >
                  <img
                    src={entry.logo}
                    alt=""
                    className="w-9 h-9 rounded-lg object-contain bg-white/10 p-1 hover:bg-white/20 transition-colors"
                  />
                </a>
              ) : (
                <img
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <h3 className="text-[0.85rem] font-semibold leading-tight">
                  {entry.title}
                </h3>
                {(entry.github ||
                  entry.deployedLink ||
...
export default function Card({
  ...
  const detailBorderClass = darkText ? "border-black/15" : "border-white/15";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          data-lenis-prevent
          className="front-detail absolute inset-0 z-10 pt-5 px-8 pb-8 opacity-0 pointer-events-none overflow-y-auto text-left flex flex-col gap-3"
        >
      ...
      >
        ...
        <div
          data-lenis-prevent
          className="absolute inset-0 z-10 pt-6 px-8 pb-8 overflow-y-auto text-left flex flex-col gap-3"
        >
          <DetailList details={details} detailBorderClass={detailBorderClass} />
        </div>
      </div>
